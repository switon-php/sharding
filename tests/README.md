# Switon Sharding Package Tests

Test suite for the Switon Sharding package, organized by test type and speed.
...
- Follow naming convention: `Sharding[Component]Test.php`
